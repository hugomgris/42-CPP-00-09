...
/*   Updated: 2025/02/17 12:19:13 by hmunoz-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(): _name("Default"), _hp(100), _ep(100), _ad(30){
	std::cout << "Default constructor called for ClapTrap" << std::endl;
}

ClapTrap::ClapTrap(const std::string &name): _name(name), _hp(100), _ep(100), _ad(30){
